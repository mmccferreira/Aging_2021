...
``` r
#calculate the percentage of top dynamic genes relative to the total of expressed genes in each tissue (obtained after filtering of low expressed genes - section 3.3 of the normalization workflow)
