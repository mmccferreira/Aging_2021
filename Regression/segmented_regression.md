...
-   [2. Data input](#data-input)
    ...
    -   [2.3 Regression analysis](#regression-analysis)
...
#### 2.3.3 Choice of threshold for dynamic Trendy fit
...
#### 2.3.6 Test differences in median breakpoint distributions
